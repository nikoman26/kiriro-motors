    ...
    <div className="bg-luxury-cream text-black min-h-screen">
      <section className="bg-[#0E0E0E] text-white pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-luxury-gold uppercase tracking-[0.35em] text-[10px] mb-4 font-bold">About Kiriro</p>
          <h1 className="font-editorial text-5xl md:text-6xl font-light max-w-3xl leading-tight mb-6">A digital-first automotive and financing partner.</h1>
