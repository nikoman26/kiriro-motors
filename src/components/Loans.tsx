    ...
    <div className="bg-[#0A0A0A] text-white min-h-screen">
      <section className="bg-[#0E0E0E] pt-24 pb-16 border-b border-white/8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-luxury-gold uppercase tracking-[0.22em] sm:tracking-[0.35em] text-[10px] mb-4 font-bold">Financial Services</p>
          <h1 className="font-editorial text-4xl sm:text-5xl md:text-6xl font-light mb-5 leading-tight">Capital for vehicles, logbooks, and land titles.</h1>
