...
The script creates or updates `admin@kiriromotors.com` by default and upserts the matching `admin_profiles` row as `owner`. Override the email with `ADMIN_EMAIL` if needed.
